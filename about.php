     ...
     <div class="tm-about-img-container">
        ...
        <div class="row tm-margin-t-mid">
                    <div class="col-xs-12">
                        ...
                        <p class="bodytext"><center>Bu blog sitesinin yapımında emeği geçen insanlar:</center></p>
                        <p class="bodytext"><center>Hatice Cengiz ,Ahsennur Uslu, Alperen Yıldırım, Sefa Çelik, Temel Şahin, Taha Tan</center> </p>
                    </div>
                </div>
