                ...
                <div class="col-md-3">
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <strong><i class="far fa-file-alt mr-1"></i> Notlarım</strong>
                        ...
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#activity"
                                        data-toggle="tab">Etkinlik</a></li>
                                <li class="nav-item"><a class="nav-link" href="#timeline" data-toggle="tab">Zaman
                                        Çizelgesi</a></li>
                                <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab">Ayarlar</a></li>
                                <li class="nav-item"><a class="nav-link" href="blog_logout.php"
                                    ...
                                    <div class="post">
                                        ...
                                        <p>
                                            <a href="#" class="link-black text-sm mr-2"><i
                                                    class="fas fa-share mr-1"></i> Paylaş</a>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid mb-3" src="admin/dist/img/photo2.png"
                                                            alt="Photo">
                                                        <img class="img-fluid" src="admin/dist/img/photo3.jpg"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                    <div class="col-sm-6">
                                                        <img class="img-fluid mb-3" src="admin/dist/img/photo4.jpg"
                                                            alt="Photo">
                                                        <img class="img-fluid" src="admin/dist/img/photo1.png"
                                                            alt="Photo">
                                                    </div>
                                                    <!-- /.col -->
                                                </div>
